...
resource "digitalocean_project" "main" {
  name        = "lukasz-piasecki-github-actions-project"
...
resource "digitalocean_vpc" "main" {
  name     = "lukasz-piasecki-github-actions-vpc"
  region   = "fra1"
  ip_range = "10.223.10.0/24"
}
...
resource "digitalocean_ssh_key" "main" {
  name       = "lukasz-piasecki-github-actions-ssh-key"
  public_key = tls_private_key.main.public_key_openssh
}

resource "digitalocean_ssh_key" "own" {
  name       = "lukasz-piasecki-github-actions-own-ssh-key"
  public_key = var.own_ssh_public_key

}

resource "digitalocean_firewall" "main" {
  name        = "lukasz-piasecki-github-actions-firewall"
